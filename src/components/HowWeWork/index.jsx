...
export default function HowWeWork() {
  ...
  return (
    <div className="w-full bg-[#15464b] flex flex-col items-center text-sm px-20 max-sm:px-7 py-28 max-sm:py-10 space-y-20">
      ...
      <div className="grid grid-cols-4 grid-rows-1 max-sm:grid-cols-2 gap-8 max-sm:gap-6 text-white">
        {SkillList.map((item, idx) => (
          <div
            ...
            key={item.id}
          >
            <div className="w-16 h-16 bg-white flex text-[#32bab3] hover:text-[#15464b] justify-center items-center hover:bg-[#32bab3] duration-300 ease-in-out">
              {item.icon}
            </div>
