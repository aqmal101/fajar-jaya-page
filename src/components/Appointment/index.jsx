...
export default function Appointment() {
  ...
  return (
    <div className="w-full h-fit bg-white flex flex-row items-center text-sm py-20 space-y-16">
      <div className="w-1/2 flex flex-col text-center space-y-10 px-16">
        ...
        <div className="w-full  flex flex-col space-y-7">
          ...
          <textarea
            ...
            placeholder="Message"
          ></textarea>
          <span className="w-fit bg-[#da844a] text-sm text-white font-semibold px-9 py-4 border border-[#da844a] hover:cursor-pointer hover:border-black hover:bg-black hover:text-white transition-all ease-in-out duration-300">
            SUBMIT FORM
          </span>
        </div>
      </div>
      <div className="w-1/2 h-[800px] bg-purple-400 flex flex-col justify-end space-y-5 p-20 items-center">
